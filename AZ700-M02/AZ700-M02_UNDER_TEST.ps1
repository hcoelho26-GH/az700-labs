...
# Unit 3 - Tasks 4 and 5 - Manual (RDP)
# Connect via RDP to CoreServicesVM and ManufacturingVM
# Run on CoreServicesVM: ipconfig — note the IPv4 address
# Run on ManufacturingVM: Test-NetConnection <IP_CoreServicesVM> -port 3389
# Expected: fails (no gateway configured yet)
...
# Unit 3 - Task 9 - Verify connections
...
# Unit 3 - Tasks 10 and 11 - Manual (RDP)
# Run on ManufacturingVM: Test-NetConnection <IP_CoreServicesVM> -port 3389
# Expected: TcpTestSucceeded: True


# Unit 7 - Task 1 - Create Virtual WAN
...
Get-AzVirtualHub -ResourceGroupName $RG -Name $HUB_NAME | Select-Object Name, Location, ProvisioningState


# Unit 7 - Task 3 - Connect ResearchVnet to Hub
