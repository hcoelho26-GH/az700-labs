...
# Part 5 - Task 1 - Criar ExpressRoute Circuit
...
# Part 5 - Task 2 - Obter Service Key
...
# Part 5 - Task 3 - Deprovision e eliminar circuit
# Só correr depois do provider ter desprovisionado (ProviderStatus = NotProvisioned)
