...
# Unit 4 - Task 5 - Verify VNets and Subnets
...
# Unit 6 - Task 2 - Link VNet for auto registration
...
# Unit 6 - Task 4 - Verify DNS records
...
# Connect via RDP to ManufacturingVM and testvm1
# Run on ManufacturingVM: Test-NetConnection 10.20.20.4 -port 3389
# Expected: fails (no peering configured yet)
